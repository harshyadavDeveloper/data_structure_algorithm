...
class Main {
    ...
    // here the TC is also 0(n) because the outer loop goes till n and innter loop
    // is fixed 5 that means it becomes O(5xn)
    // and constants are ignored because our big O is only interested in how does
    // the time increases when the input n increases
}